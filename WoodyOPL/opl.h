...
// general functions
__declspec(dllexport) void adlib_init(Bit32u samplerate);
__declspec(dllexport) void adlib_write(Bitu idx, Bit8u val);
__declspec(dllexport) void adlib_getsample(Bit16s* sndptr, Bits numsamples);
